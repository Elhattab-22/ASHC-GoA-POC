 ...
 * Generated on Fri, 10 Jul 2026 17:17:44 GMT
 */
...
:root {
  ...
  --goa-color-extended-prairie-text-dark: #47372a;
  ...
  --goa-color-extended-lilac-text-dark: #151d83;
  ...
  --goa-color-extended-dawn-text-dark: #310c46;
  ...
  --goa-color-extended-sunset-text-dark: #7a141a;
  ...
  --goa-color-extended-pasture-text-dark: #174c38;
  ...
  --goa-color-extended-sky-text-dark: #093937;
  ...
  --goa-color-surface-item-hover: #f2f0f0;
  --goa-color-surface-heading-hover: #e9e9e9;
  --goa-color-surface-widget-hover: #f8f8f8;
  --goa-color-surface-card-hover: #f8f8f8;
  --goa-color-surface-app-header: #ffffff;
  --goa-color-surface-popover: #ffffff;
  --goa-color-surface-container-heading: #f2f0f0;
  --goa-color-surface-table-data: #ffffff;
  --goa-color-surface-400: #f8f8f8;
  --goa-color-surface-350: #f2f0f0;
  --goa-color-surface-300: #ffffff;
  --goa-color-surface-250: #f2f0f0;
  --goa-color-surface-200: #f8f8f8;
  --goa-color-surface-150: #f8f8f8;
  --goa-color-surface-100: #ffffff;
  --goa-color-surface-50: #ffffff;
  --goa-color-surface-0: #f8f8f8;
  ...
  --goa-work-side-menu-logo: initial;
  ...
  --goa-scroll-panel-content-shadow-top-bottom: inset 0px 4px 8px -4px rgba(0,0,0,0.175), inset 0px -4px 8px -4px rgba(0,0,0,0.175);
  --goa-scroll-panel-content-shadow-top: inset 0px 4px 8px -4px rgba(0,0,0,0.25);
  --goa-scroll-panel-content-shadow-bottom: inset 0px -4px 8px -4px rgba(0,0,0,0.25);
  ...
  --goa-notification-banner-padding-tb-compact: 0.9375rem;
  --goa-notification-banner-padding-tb: 1.4375rem;
  ...
  --goa-app-header-logo-desktop: initial;
  --goa-app-header-logo-mobile: initial;
  ...
  --goa-dropdown-multiselect-compact-height: 40px;
  --goa-dropdown-multiselect-transition: box-shadow 0.05s ease-in;
  --goa-dropdown-multiselect-height: 56px;
  ...
  --goa-input-border-width-focus: var(--goa-border-width-l);
  --goa-input-border-width-hover: var(--goa-border-width-m);
  --goa-input-border-width-default: var(--goa-border-width-s);
  --goa-input-color-background-readonly-content: var(--goa-color-greyscale-150);
  --goa-input-color-background-readonly: var(--goa-color-greyscale-100);
  --goa-input-color-background-error: var(--goa-color-emergency-light);
  --goa-input-color-background-disabled: var(--goa-color-greyscale-150);
  --goa-input-color-background-default: var(--goa-color-greyscale-white);
  --goa-input-color-border-error-hover: var(--goa-color-interactive-error-hover);
  --goa-input-color-border-error: var(--goa-color-interactive-error);
  --goa-input-color-border-disabled: var(--goa-color-greyscale-300);
  --goa-input-color-border-focus: var(--goa-color-interactive-default);
  --goa-input-color-border-hover: var(--goa-color-greyscale-black);
  --goa-input-color-border-default-light: var(--goa-color-greyscale-200);
  --goa-input-color-border-default: var(--goa-color-greyscale-500);
  --goa-input-color-text-placeholder: var(--goa-color-greyscale-400);
  --goa-input-color-text-disabled: var(--goa-color-greyscale-500);
  --goa-input-color-text-error: var(--goa-color-emergency-dark);
  --goa-input-color-text-helper: var(--goa-color-greyscale-800);
  --goa-input-color-text-secondary: var(--goa-color-greyscale-800);
  ...
  --goa-typography-mobile-body-l: var(--goa-font-weight-regular) var(--goa-font-size-7)/var(--goa-line-height-5) var(--goa-font-family-sans);
  ...
  --goa-typography-body-l: var(--goa-font-weight-regular) var(--goa-font-size-6)/var(--goa-line-height-5) var(--goa-font-family-sans);
  ...
  --goa-color-text-secondary: var(--goa-color-greyscale-600);
  --goa-color-text-default: var(--goa-color-greyscale-black);
  --goa-color-interactive-disabled: var(--goa-color-greyscale-300);
  --goa-workspace-layout-mobile-header-padding-left: var(--goa-space-2xl);
  --goa-workspace-layout-mobile-toggle-size: var(--goa-icon-size-xl);
  --goa-workspace-layout-mobile-toggle-left: var(--goa-space-s);
  --goa-workspace-layout-mobile-toggle-top: var(--goa-space-l);
  --goa-workspace-layout-footer-scroll-shadow: var(--goa-shadow-shallow-above);
  --goa-workspace-layout-footer-scroll-border-color: var(--goa-color-greyscale-200);
  --goa-workspace-layout-footer-border-top: var(--goa-border-width-s) solid var(--goa-color-greyscale-200);
  --goa-workspace-layout-footer-bg-color: var(--goa-color-greyscale-white);
  --goa-workspace-layout-header-scroll-shadow: var(--goa-shadow-shallow-below);
  --goa-workspace-layout-header-scroll-border-color: var(--goa-color-greyscale-200);
  --goa-workspace-layout-header-border-bottom: var(--goa-border-width-s) solid var(--goa-color-greyscale-200);
  --goa-workspace-layout-header-bg-color: var(--goa-color-greyscale-white);
  --goa-workspace-layout-card-bg-color: var(--goa-color-greyscale-white);
  --goa-workspace-layout-bg-color: var(--goa-color-greyscale-50);
  ...
  --goa-work-side-menu-popover-shadow: var(--goa-shadow-raised-light);
  ...
  --goa-tooltip-padding: var(--goa-space-m);
  --goa-tooltip-gap: var(--goa-space-2xs);
  --goa-tooltip-color-bg: var(--goa-color-greyscale-600);
  --goa-tooltip-border-radius: var(--goa-border-radius-xl);
  --goa-tooltip-border-focus: var(--goa-border-width-l) solid var(--goa-color-interactive-focus);
  --goa-text-area-padding-compact: var(--goa-space-s);
  --goa-text-area-padding: var(--goa-space-m);
  --goa-temporary-notification-progress-bar-color-fill: var(--goa-color-greyscale-white);
  --goa-temporary-notification-progress-bar-color-bg: var(--goa-color-greyscale-400);
  --goa-temporary-notification-progress-bar-border-radius: var(--goa-border-radius-l);
  --goa-temporary-notification-icon-size: var(--goa-icon-size-xl);
  --goa-temporary-notification-column-gap: var(--goa-space-s);
  --goa-temporary-notification-row-gap: var(--goa-space-s);
  --goa-temporary-notification-padding-with-progress: var(--goa-space-m) var(--goa-space-l) 22px var(--goa-space-l);
  --goa-temporary-notification-padding-text-top: var(--goa-space-2xs);
  --goa-temporary-notification-padding: var(--goa-space-m) var(--goa-space-l);
  --goa-temporary-notification-border-radius: var(--goa-border-radius-l);
  --goa-temporary-notification-border-width: var(--goa-border-width-s);
  --goa-temporary-notification-color-border: var(--goa-color-greyscale-700);
  --goa-temporary-notification-color-bg-failure: var(--goa-color-emergency-default);
  --goa-temporary-notification-color-bg-success: var(--goa-color-success-default);
  --goa-tabs-padding-bottom-small-screen: var(--goa-space-m);
  --goa-tabs-gap-small-screen: var(--goa-space-2xs);
  --goa-tabs-gap: var(--goa-space-m);
  --goa-tabs-bottom-border: var(--goa-border-width-s) solid var(--goa-color-greyscale-150);
  --goa-tab-typography-selected: var(--goa-font-weight-semi-bold) var(--goa-font-size-3)/var(--goa-line-height-2) var(--goa-font-family-sans);
  --goa-tab-typography: var(--goa-font-weight-medium) var(--goa-font-size-3)/var(--goa-line-height-2) var(--goa-font-family-sans);
  --goa-tab-padding-mobile: var(--goa-space-2xs) var(--goa-space-s) var(--goa-space-2xs) 15px;
  --goa-tab-padding: var(--goa-space-xs) var(--goa-space-2xs) 9px var(--goa-space-2xs);
  --goa-tab-indicator-color-hover: var(--goa-color-greyscale-300);
  --goa-tab-indicator-color-active: var(--goa-color-interactive-default);
  --goa-tab-color-text-not-selected: var(--goa-color-greyscale-600);
  --goa-tab-color-text-selected: var(--goa-color-interactive-default);
  --goa-tab-color-bg-hover-small-screen: var(--goa-color-greyscale-50);
  --goa-tab-color-bg-selected-small-screen: var(--goa-color-info-light);
  --goa-tab-indicator-border-radius-small-screen: 0px var(--goa-border-radius-s) var(--goa-border-radius-s) 0px;
  --goa-tab-indicator-border-radius-desktop: var(--goa-border-radius-s) var(--goa-border-radius-s) 0px 0px;
  --goa-tab-indicator-width: var(--goa-border-width-xl);
  ...
  --goa-tab-border-focus: var(--goa-border-width-xl) solid var(--goa-color-interactive-focus);
  ...
  --goa-table-padding-data: var(--goa-space-s) var(--goa-space-m) var(--goa-space-s) var(--goa-space-m);
  --goa-table-padding-heading-relaxed: 18px var(--goa-space-m) var(--goa-space-m) var(--goa-space-m);
  --goa-table-padding-heading: 18px var(--goa-space-m) var(--goa-space-m) var(--goa-space-m);
  --goa-table-border-radius-container: var(--goa-border-radius-2xl);
  --goa-table-container-border: var(--goa-border-width-s) solid var(--goa-color-greyscale-150);
  --goa-table-data-border: var(--goa-border-width-s) solid var(--goa-color-greyscale-150);
  --goa-table-heading-border: var(--goa-border-width-m) solid var(--goa-color-greyscale-150);
  --goa-table-color-bg-data: var(--goa-color-greyscale-white);
  --goa-table-color-bg-heading: var(--goa-color-greyscale-50);
  --goa-table-color-bg-heading-hover: var(--goa-color-greyscale-100);
  --goa-table-color-heading-hover: var(--goa-color-interactive-hover);
  --goa-table-color-heading: var(--goa-color-greyscale-600);
  --goa-skeleton-loading-color-bg: var(--goa-color-greyscale-100);
  --goa-side-menu-group-border-radius-open: var(--goa-border-radius-xl);
  --goa-side-menu-item-border-radius: var(--goa-border-radius-l);
  --goa-side-menu-group-item-typography-current: var(--goa-font-weight-bold) var(--goa-font-size-2)/var(--goa-line-height-1) var(--goa-font-family-sans);
  --goa-side-menu-child-border-width: var(--goa-border-width-xl);
  --goa-side-menu-typography-item-current: var(--goa-font-weight-semi-bold) 16px/22px var(--goa-font-family-sans);
  --goa-side-menu-typography-item: var(--goa-font-weight-regular) 16px/22px var(--goa-font-family-sans);
  ...
  --goa-side-menu-group-border-radius: var(--goa-border-radius-xl);
  --goa-side-menu-parent-padding: var(--goa-space-xs) var(--goa-space-s);
  --goa-side-menu-parent-color-bg-selected: var(--goa-color-greyscale-100);
  --goa-side-menu-padding-child: var(--goa-space-2xs) var(--goa-space-xs);
  --goa-side-menu-padding-item: var(--goa-space-xs) var(--goa-space-s);
  --goa-side-menu-padding: var(--goa-space-m) var(--goa-space-xs) var(--goa-space-m) var(--goa-space-m);
  ...
  --goa-side-menu-items-gap: var(--goa-space-2xs);
  --goa-side-menu-heading-padding: var(--goa-space-2xs) var(--goa-space-xs);
  ...
  --goa-side-menu-heading-color-bg: var(--goa-color-greyscale-white);
  --goa-side-menu-heading-color: var(--goa-color-greyscale-600);
  --goa-side-menu-heading-border: var(--goa-border-width-s) solid var(--goa-color-greyscale-100);
  ...
  --goa-scroll-panel-footer-scroll-shadow: var(--goa-shadow-shallow-above);
  --goa-scroll-panel-footer-scroll-border: var(--goa-color-greyscale-150);
  --goa-scroll-panel-header-scroll-shadow: var(--goa-shadow-shallow-below);
  --goa-scroll-panel-header-scroll-border: var(--goa-color-greyscale-150);
  --goa-scroll-panel-footer-color-bg: var(--goa-color-greyscale-white);
  --goa-scroll-panel-header-color-bg: var(--goa-color-greyscale-white);
  --goa-scroll-panel-color-bg: var(--goa-color-greyscale-white);
  ...
  --goa-radio-inner-color-hover: var(--goa-color-interactive-hover);
  --goa-radio-inner-color-error: var(--goa-color-interactive-error);
  --goa-radio-inner-color: var(--goa-color-interactive-default);
  --goa-radio-group-gap-vertical-compact: var(--goa-space-s);
  ...
  --goa-radio-border-hover: var(--goa-border-width-m) solid var(--goa-color-greyscale-black);
  ...
  --goa-radio-border-disabled: var(--goa-border-width-s) solid #b1b1b1;
  --goa-radio-border-checked-hover: var(--goa-border-width-m) solid var(--goa-color-interactive-hover);
  --goa-radio-border-checked-error-hover: var(--goa-border-width-m) solid #ba0000;
  --goa-radio-border-checked-error-disabled: var(--goa-border-width-s) solid #f58185;
  --goa-radio-border-checked-error: var(--goa-border-width-m) solid var(--goa-color-interactive-error);
  --goa-radio-border-checked-disabled: var(--goa-border-width-s) solid var(--goa-color-interactive-disabled);
  --goa-radio-border-checked: var(--goa-border-width-m) solid var(--goa-color-interactive-default);
  --goa-radio-border: var(--goa-border-width-s) solid var(--goa-color-greyscale-500);
  ...
  --goa-push-drawer-border-radius: var(--goa-border-radius-3xl);
  --goa-circular-progress-small-margin-top: var(--goa-space-l);
  --goa-circular-progress-large-margin-top: var(--goa-space-xl);
  --goa-popover-border: var(--goa-border-width-2xs) solid var(--goa-color-greyscale-150);
  --goa-popover-box-shadow: var(--goa-shadow-raised-light);
  --goa-popover-padding: var(--goa-space-xs);
  --goa-popover-color-bg: var(--goa-color-greyscale-white);
  --goa-popover-border-radius: var(--goa-border-radius-xl);
  --goa-popover-border-focus: var(--goa-border-width-l) solid var(--goa-color-interactive-focus);
  --goa-pagination-gap: var(--goa-space-m);
  --goa-notification-banner-emergency-low-close-bg-hover: var(--goa-color-emergency-border);
  --goa-notification-banner-emergency-high-close-bg-hover: var(--goa-color-emergency-dark);
  --goa-notification-banner-important-low-close-bg-hover: var(--goa-color-important-border);
  ...
  --goa-notification-banner-emergency-low-color-bg: var(--goa-color-emergency-light);
  --goa-notification-banner-emergency-high-color-icon: var(--goa-color-greyscale-white);
  --goa-notification-banner-emergency-high-color-bg: var(--goa-color-emergency-default);
  --goa-notification-banner-important-low-color-border: var(--goa-color-important-border);
  --goa-notification-banner-important-low-color-icon: var(--goa-color-important-text);
  --goa-notification-banner-important-low-color-text: var(--goa-color-important-text);
  --goa-notification-banner-important-low-color-bg: var(--goa-color-important-light);
  --goa-notification-banner-important-high-color-icon: var(--goa-color-important-text-dark);
  --goa-notification-banner-important-high-color-text: var(--goa-color-important-text-dark);
  --goa-notification-banner-important-high-color-bg: var(--goa-color-important-default);
  --goa-notification-banner-information-low-color-border: var(--goa-color-info-border);
  --goa-notification-banner-information-low-color-icon: var(--goa-color-info-default);
  --goa-notification-banner-information-low-color-text: var(--goa-color-info-default);
  --goa-notification-banner-information-low-color-bg: var(--goa-color-info-light);
  --goa-notification-banner-information-high-color-icon: var(--goa-color-greyscale-white);
  --goa-notification-banner-information-high-color-bg: var(--goa-color-info-default);
  --goa-notification-banner-padding-lr-large-screen-compact: var(--goa-space-2xl);
  --goa-notification-banner-padding-lr-medium-screen-compact: var(--goa-space-m);
  --goa-notification-banner-padding-lr-small-screen-compact: var(--goa-space-xs);
  --goa-notification-banner-gap-compact: var(--goa-space-xs);
  ...
  --goa-modal-callout-emergency-icon: var(--goa-color-emergency-default);
  --goa-modal-callout-emergency-border: var(--goa-color-emergency-border);
  --goa-modal-callout-emergency-bg: var(--goa-color-emergency-background);
  --goa-modal-callout-important-icon: var(--goa-color-warning-dark);
  --goa-modal-callout-important-border: var(--goa-color-warning-border);
  --goa-modal-callout-important-bg: var(--goa-color-warning-background);
  --goa-modal-callout-success-icon: var(--goa-color-success-default);
  --goa-modal-callout-success-border: var(--goa-color-success-border);
  --goa-modal-callout-success-bg: var(--goa-color-success-background);
  ...
  --goa-modal-color-bg: var(--goa-color-greyscale-white);
  ...
  --goa-modal-header-typography: var(--goa-font-weight-semi-bold) var(--goa-font-size-4)/var(--goa-line-height-4) var(--goa-font-family-sans);
  ...
  --goa-modal-border-radius: var(--goa-border-radius-xl);
  ...
  --goa-link-focus-offset: var(--goa-space-3xs);
  --goa-link-border-focus: var(--goa-border-width-l) solid var(--goa-color-interactive-focus);
  --goa-link-border-radius-focus: var(--goa-border-radius-s);
  --goa-link-color-light-hover: var(--goa-color-greyscale-150);
  --goa-link-color-dark-visited: var(--goa-color-interactive-visited);
  --goa-link-color-dark-hover: var(--goa-color-greyscale-700);
  --goa-link-color-dark-default: var(--goa-color-greyscale-black);
  --goa-link-color-interactive-visited: var(--goa-color-interactive-visited);
  --goa-link-color-interactive-hover: var(--goa-color-interactive-hover);
  --goa-link-color-interactive-default: var(--goa-color-interactive-default);
  --goa-link-icon-size-large: var(--goa-icon-size-3);
  --goa-link-icon-size-medium: var(--goa-icon-size-2);
  --goa-link-icon-size-small: var(--goa-icon-size-1);
  --goa-link-gap-medium: var(--goa-space-2xs);
  --goa-link-gap: var(--goa-space-2xs);
  --goa-link-typography-large: var(--goa-font-weight-regular) var(--goa-font-size-6)/var(--goa-line-height-5) var(--goa-font-family-sans);
  --goa-link-typography-medium: var(--goa-font-weight-regular) var(--goa-font-size-4)/var(--goa-line-height-3) var(--goa-font-family-sans);
  --goa-link-typography-small: var(--goa-font-weight-regular) var(--goa-font-size-3)/var(--goa-line-height-2) var(--goa-font-family-sans);
  --goa-link-typography-xsmall: var(--goa-font-weight-regular) var(--goa-font-size-2)/var(--goa-line-height-1) var(--goa-font-family-sans);
  ...
  --goa-icon-button-dark-disabled-color: var(--goa-color-greyscale-500);
  ...
  --goa-icon-button-light-hover-color-bg: var(--goa-color-greyscale-600);
  ...
  --goa-app-header-nav-menu-dropdown-border: var(--goa-border-width-2xs) solid var(--goa-color-greyscale-150);
  ...
  --goa-app-header-padding-secondary-nav-item-in-menu: var(--goa-space-s) var(--goa-space-xs) var(--goa-space-s) var(--goa-space-l);
  --goa-app-header-padding-nav-item-in-menu: var(--goa-space-xs);
  --goa-app-header-nav-hover-indicator-color: var(--goa-color-greyscale-200);
  --goa-app-header-nav-active-indicator-color: var(--goa-color-interactive-default);
  --goa-app-header-border-nav-item-current: var(--goa-border-width-xl) solid var(--goa-color-interactive-default);
  --goa-app-header-border-nav-item-hover: var(--goa-border-width-xl) solid var(--goa-color-greyscale-200);
  --goa-app-header-border-nav-item-default: var(--goa-border-width-xl) solid transparent;
  --goa-app-header-height-nav-item: var(--goa-space-2xl);
  --goa-app-header-padding-nav-item: var(--goa-space-2xs) var(--goa-space-2xs) 0 var(--goa-space-2xs);
  --goa-app-header-typography-nav-item: var(--goa-font-weight-medium) var(--goa-font-size-3)/var(--goa-line-height-2) var(--goa-font-family-sans);
  --goa-app-header-nav-item-gap: var(--goa-space-m);
  --goa-app-header-nav-bar-bg: var(--goa-color-greyscale-50);
  ...
  --goa-app-header-logo-service-gap: var(--goa-space-2xl);
  --goa-app-header-logo-mobile-size: var(--goa-space-xl);
  --goa-app-header-logo-desktop-height: var(--goa-space-xl);
  --goa-app-header-padding-tablet: var(--goa-space-xl);
  --goa-app-header-padding-mobile: var(--goa-space-m);
  --goa-app-header-padding-desktop: var(--goa-space-2xl);
  --goa-app-header-padding-v: var(--goa-space-s);
  --goa-app-header-padding-h-mobile: var(--goa-space-m);
  --goa-app-header-padding-h-desktop: var(--goa-space-2xl);
  --goa-app-header-border-focus: var(--goa-border-width-l) solid var(--goa-color-interactive-focus);
  --goa-app-header-border-bottom: var(--goa-border-width-s) solid var(--goa-color-greyscale-150);
  ...
  --goa-form-item-optional-label-color: var(--goa-color-greyscale-600);
  --goa-form-item-message-stack-gap-compact: var(--goa-space-2xs);
  --goa-form-item-message-stack-gap: var(--goa-space-xs);
  --goa-form-item-message-margin-top-selection-compact: var(--goa-space-s);
  --goa-form-item-message-margin-top-selection-regular: var(--goa-space-m);
  --goa-form-item-message-margin-top-compact: var(--goa-space-xs);
  --goa-form-item-message-margin-top-regular: var(--goa-space-s);
  --goa-form-item-message-margin-top-large: var(--goa-space-m);
  --goa-form-item-message-gap: var(--goa-space-2xs);
  --goa-form-item-label-compact-typography: var(--goa-font-weight-semi-bold) var(--goa-font-size-3)/var(--goa-line-height-2) var(--goa-font-family-sans);
  --goa-form-item-label-typography: var(--goa-font-weight-semi-bold) var(--goa-font-size-4)/var(--goa-line-height-4) var(--goa-font-family-sans);
  --goa-form-item-label-large-typography: var(--goa-font-weight-bold) var(--goa-font-size-8)/var(--goa-line-height-5) var(--goa-font-family-sans);
  --goa-footer-meta-links-margin: var(--goa-space-none);
  --goa-footer-meta-links-gap: var(--goa-space-xl);
  --goa-footer-typography-small-screen: var(--goa-font-size-3);
  --goa-footer-padding-small-screen: var(--goa-space-l) var(--goa-space-m);
  --goa-footer-padding-medium-screen: var(--goa-space-l) var(--goa-space-xl);
  --goa-footer-padding-large-screen: var(--goa-space-l) var(--goa-space-3xl);
  --goa-footer-link-focus-border-radius: var(--goa-border-radius-s);
  --goa-footer-link-focus: var(--goa-border-width-l) solid var(--goa-color-interactive-focus);
  --goa-footer-color-links-secondary-hover: var(--goa-color-greyscale-800);
  --goa-footer-color-links-hover: var(--goa-color-greyscale-700);
  --goa-footer-color-links: var(--goa-color-greyscale-black);
  --goa-footer-color-bg: var(--goa-color-greyscale-100);
  --goa-footer-border-top: var(--goa-border-width-m) solid var(--goa-color-greyscale-150);
  --goa-footer-border-bottom: var(--goa-border-width-none) solid var(--goa-color-brand-default);
  --goa-filter-chip-close-button-error-hover-bg-color: var(--goa-input-color-background-error-hover);
  --goa-filter-chip-min-height: var(--goa-space-xl);
  --goa-filter-chip-line-height: var(--goa-line-height-2);
  --goa-filter-chip-gap: var(--goa-space-s);
  --goa-filter-chip-padding-horizontal-right: var(--goa-space-xs);
  --goa-filter-chip-padding-horizontal-left: var(--goa-space-s);
  --goa-filter-chip-secondary-text-color: var(--goa-color-greyscale-600);
  --goa-filter-chip-icon-color: var(--goa-color-greyscale-600);
  --goa-filter-chip-bg-color: var(--goa-color-greyscale-white);
  --goa-filter-chip-border: var(--goa-border-width-s) solid var(--goa-color-greyscale-300);
  --goa-filter-chip-border-radius: var(--goa-border-radius-3xl);
  ...
  --goa-dropdown-multiselect-divider: var(--goa-border-width-s) solid var(--goa-color-greyscale-200);
  --goa-dropdown-multiselect-compact-item-padding: 0 var(--goa-space-xs);
  --goa-dropdown-multiselect-compact-padding: 0 var(--goa-space-s);
  --goa-dropdown-multiselect-menu-margin: var(--goa-space-xs);
  --goa-dropdown-multiselect-space-icon-text: var(--goa-space-s);
  --goa-dropdown-multiselect-padding-lr: var(--goa-space-s);
  --goa-dropdown-multiselect-padding-vertical: var(--goa-space-m);
  --goa-dropdown-multiselect-padding: var(--goa-space-m) var(--goa-space-s);
  --goa-dropdown-multiselect-item-border-radius: var(--goa-border-radius-s);
  --goa-dropdown-multiselect-item-padding: var(--goa-space-s) var(--goa-space-xs);
  --goa-dropdown-multiselect-item-color-text-selected: var(--goa-color-greyscale-white);
  --goa-dropdown-multiselect-item-color-bg-selected-hover: var(--goa-color-interactive-hover);
  --goa-dropdown-multiselect-item-color-bg-selected: var(--goa-color-interactive-default);
  --goa-dropdown-multiselect-item-color-bg-hover: var(--goa-color-greyscale-100);
  --goa-dropdown-compact-item-padding: 0 var(--goa-space-xs);
  --goa-dropdown-compact-padding: 0 var(--goa-space-s);
  --goa-dropdown-menu-margin: var(--goa-space-xs);
  --goa-dropdown-space-icon-text: var(--goa-space-s);
  --goa-dropdown-padding-lr: var(--goa-space-s);
  --goa-dropdown-padding-vertical: var(--goa-space-m);
  --goa-dropdown-padding: var(--goa-space-m) var(--goa-space-s);
  --goa-dropdown-item-border-radius: var(--goa-border-radius-s);
  --goa-dropdown-item-padding: var(--goa-space-s) var(--goa-space-xs);
  ...
  --goa-dropdown-color-bg-error-hover: var(--goa-input-color-background-error-hover);
  ...
  --goa-details-icon-color-hover: var(--goa-color-interactive-hover);
  --goa-details-typography: var(--goa-font-weight-semi-bold) var(--goa-font-size-4)/var(--goa-line-height-4) var(--goa-font-family-sans);
  ...
  --goa-details-content-left-border: var(--goa-border-width-s) solid var(--goa-color-greyscale-200);
  ...
  --goa-date-input-day-today-outline-offset: var(--goa-space-3xs);
  --goa-date-input-day-border-focus: var(--goa-border-width-l) solid var(--goa-color-interactive-focus);
  --goa-date-input-day-color-bg-hover: var(--goa-color-greyscale-150);
  --goa-date-input-day-border-radius: var(--goa-border-radius-xs);
  ...
  --goa-date-input-day-underline-today: var(--goa-border-width-xl) solid var(--goa-color-interactive-default);
  --goa-date-input-day-of-week-margin: var(--goa-space-xs) 0;
  --goa-container-important-border: var(--goa-border-width-s) solid var(--goa-color-warning-border);
  ...
  --goa-container-success-border: var(--goa-border-width-s) solid var(--goa-color-success-border);
  ...
  --goa-container-error-border: var(--goa-border-width-s) solid var(--goa-color-emergency-border);
  ...
  --goa-checkbox-gap: var(--goa-space-s);
  --goa-checkbox-color-bg-checked-error-hover: var(--goa-color-interactive-error-hover);
  ...
  --goa-checkbox-color-bg-checked-disabled: var(--goa-color-greyscale-300);
  --goa-checkbox-color-bg-checked: var(--goa-color-interactive-default);
  --goa-checkbox-border-error-hover: var(--goa-border-width-m) solid var(--goa-input-color-border-error-hover);
  --goa-checkbox-border-hover: var(--goa-border-width-m) solid var(--goa-input-color-border-hover);
  --goa-checkbox-border-focus: var(--goa-border-width-l) solid var(--goa-input-color-border-focus);
  --goa-checkbox-border-error: var(--goa-border-width-m) solid var(--goa-input-color-border-error);
  --goa-checkbox-border-disabled-error: var(--goa-border-width-m) solid #F58185;
  --goa-callout-h-emergency-icon-color: var(--goa-color-greyscale-white);
  --goa-callout-emergency-icon-color: var(--goa-color-emergency-default);
  --goa-callout-h-success-icon-color: var(--goa-color-greyscale-white);
  --goa-callout-success-icon-color: var(--goa-color-success-default);
  --goa-callout-h-important-icon-color: var(--goa-color-greyscale-800);
  --goa-callout-important-icon-color: var(--goa-color-warning-dark);
  --goa-callout-h-info-icon-color: var(--goa-color-greyscale-white);
  --goa-callout-info-icon-color: var(--goa-color-info-default);
  --goa-callout-l-emergency-content-bg-color: var(--goa-color-emergency-background);
  --goa-callout-h-emergency-content-bg-color: var(--goa-color-emergency-background);
  --goa-callout-emergency-content-bg-color: var(--goa-color-greyscale-white);
  --goa-callout-l-success-content-bg-color: var(--goa-color-success-background);
  --goa-callout-h-success-content-bg-color: var(--goa-color-success-background);
  --goa-callout-success-content-bg-color: var(--goa-color-greyscale-white);
  --goa-callout-l-important-content-bg-color: var(--goa-color-warning-background);
  --goa-callout-h-important-content-bg-color: var(--goa-color-warning-background);
  --goa-callout-important-content-bg-color: var(--goa-color-greyscale-white);
  --goa-callout-l-info-content-bg-color: var(--goa-color-info-background);
  --goa-callout-h-info-content-bg-color: var(--goa-color-info-background);
  --goa-callout-info-content-bg-color: var(--goa-color-greyscale-white);
  --goa-callout-h-emergency-heading-bg-color: var(--goa-color-emergency-default);
  --goa-callout-emergency-heading-bg-color: var(--goa-color-emergency-light);
  --goa-callout-h-success-heading-bg-color: var(--goa-color-success-default);
  --goa-callout-success-heading-bg-color: var(--goa-color-success-light);
  --goa-callout-h-important-heading-bg-color: var(--goa-color-warning-default);
  --goa-callout-important-heading-bg-color: var(--goa-color-warning-light);
  --goa-callout-h-info-heading-bg-color: var(--goa-color-info-default);
  --goa-callout-info-heading-bg-color: var(--goa-color-info-light);
  --goa-callout-l-emergency-border-color: var(--goa-color-emergency-border);
  --goa-callout-h-emergency-border-color: var(--goa-color-emergency-border);
  --goa-callout-l-success-border-color: var(--goa-color-success-border);
  --goa-callout-h-success-border-color: var(--goa-color-success-border);
  --goa-callout-l-important-border-color: var(--goa-color-warning-border);
  --goa-callout-h-important-border-color: var(--goa-color-warning-border);
  --goa-callout-l-info-border-color: var(--goa-color-info-border);
  --goa-callout-h-info-border-color: var(--goa-color-info-border);
  --goa-callout-l-without-heading-body-padding: 0.875rem var(--goa-space-s) var(--goa-space-m) 0;
  --goa-callout-heading-padding: var(--goa-space-s) var(--goa-space-s) var(--goa-space-s) 1.125rem;
  --goa-callout-heading-typography: var(--goa-font-weight-semi-bold) var(--goa-font-size-4)/var(--goa-line-height-2) var(--goa-font-family-sans);
  --goa-callout-heading-gap: var(--goa-space-xs);
  ...
  --goa-button-tertiary-disabled-color-border: var(--goa-color-greyscale-200);
  --goa-button-tertiary-destructive-focus-color-text: var(--goa-color-emergency-dark);
  --goa-button-tertiary-destructive-hover-border: var(--goa-border-width-s) solid var(--goa-color-emergency-dark);
  ...
  --goa-button-tertiary-destructive-color-border: var(--goa-color-emergency-border);
  ...
  --goa-button-secondary-destructive-focus-border: var(--goa-border-width-none) solid transparent;
  ...
  --goa-button-secondary-inverse-color-bg: var(--goa-color-interactive-secondary);
  --goa-button-secondary-inverse-color-text: var(--goa-color-interactive-hover);
  --goa-button-secondary-disabled-color-text: var(--goa-color-greyscale-400);
  --goa-button-secondary-disabled-color-bg: var(--goa-color-greyscale-150);
  ...
  --goa-button-secondary-destructive-hover-color-bg: var(--goa-input-color-background-error-hover);
  --goa-button-secondary-destructive-hover-border: var(--goa-border-width-none) solid transparent;
  --goa-button-secondary-destructive-border: var(--goa-border-width-none) solid transparent;
  --goa-button-secondary-destructive-color-bg: var(--goa-color-emergency-light);
  --goa-button-secondary-destructive-color-text: var(--goa-color-emergency-dark);
  --goa-button-secondary-focus-border: var(--goa-border-width-none) solid transparent;
  --goa-button-secondary-focus-color-text: var(--goa-color-interactive-hover);
  --goa-button-secondary-focus-color-bg: var(--goa-color-interactive-secondary);
  --goa-button-secondary-hover-border: var(--goa-border-width-none) solid transparent;
  --goa-button-secondary-hover-color-text: var(--goa-color-interactive-hover);
  --goa-button-secondary-hover-color-bg: var(--goa-color-interactive-secondary-hover);
  --goa-button-secondary-border: var(--goa-border-width-none) solid transparent;
  --goa-button-secondary-color-text: var(--goa-color-interactive-hover);
  --goa-button-secondary-color-bg: var(--goa-color-interactive-secondary);
  --goa-button-primary-inverse-focus-color-bg: var(--goa-color-interactive-default);
  --goa-button-primary-inverse-hover-color-bg: var(--goa-color-interactive-hover);
  --goa-button-primary-inverse-color-bg: var(--goa-color-interactive-default);
  --goa-button-primary-destructive-focus-color-bg: var(--goa-color-emergency-default);
  ...
  --goa-button-primary-focus-border: var(--goa-border-width-none) solid transparent;
  --goa-button-primary-focus-color-bg: var(--goa-color-interactive-default);
  --goa-button-primary-hover-border: var(--goa-border-width-none) solid transparent;
  --goa-button-primary-hover-color-bg: var(--goa-color-interactive-hover);
  --goa-button-primary-border: var(--goa-border-width-none) solid transparent;
  --goa-button-primary-color-bg: var(--goa-color-interactive-default);
  --goa-button-compact-icon-size: var(--goa-icon-size-3);
  --goa-button-icon-size: var(--goa-icon-size-4);
  --goa-button-gap: var(--goa-space-xs);
  --goa-button-text-start: var(--goa-font-weight-medium) var(--goa-font-size-5)/var(--goa-line-height-05) var(--goa-font-family-sans);
  --goa-button-text-compact: var(--goa-font-weight-medium) var(--goa-font-size-4)/var(--goa-line-height-05) var(--goa-font-family-sans);
  --goa-button-text: var(--goa-font-weight-medium) var(--goa-font-size-5)/var(--goa-line-height-1) var(--goa-font-family-sans);
  --goa-button-padding-lr-start: var(--goa-space-xl);
  ...
  --goa-badge-archived-color-bg: var(--goa-color-greyscale-200);
  --goa-badge-default-subtle-border: inset 0 0 0 var(--goa-border-width-s) var(--goa-color-greyscale-200);
  --goa-badge-default-subtle-color-bg: var(--goa-color-greyscale-100);
  --goa-badge-default-color-bg: var(--goa-color-greyscale-800);
  --goa-badge-emergency-subtle-border: inset 0 0 0 var(--goa-border-width-s) var(--goa-color-emergency-border);
  --goa-badge-emergency-subtle-color-content: var(--goa-color-emergency-text-dark);
  --goa-badge-emergency-subtle-color-bg: var(--goa-color-emergency-light);
  --goa-badge-emergency-color-content: var(--goa-color-emergency-text-inverse);
  --goa-badge-emergency-color-bg: var(--goa-color-emergency-default);
  --goa-badge-important-subtle-border: inset 0 0 0 var(--goa-border-width-s) var(--goa-color-warning-border);
  --goa-badge-important-subtle-color-content: var(--goa-color-warning-text-dark);
  --goa-badge-important-subtle-color-bg: var(--goa-color-warning-light);
  --goa-badge-important-color-content: var(--goa-color-warning-text-dark);
  --goa-badge-important-color-bg: var(--goa-color-warning-default);
  --goa-badge-success-subtle-border: inset 0 0 0 var(--goa-border-width-s) var(--goa-color-success-border);
  --goa-badge-success-subtle-color-content: var(--goa-color-success-text-dark);
  --goa-badge-success-subtle-color-bg: var(--goa-color-success-light);
  --goa-badge-success-color-content: var(--goa-color-success-text-inverse);
  --goa-badge-success-color-bg: var(--goa-color-success-default);
  --goa-badge-info-subtle-border: inset 0 0 0 var(--goa-border-width-s) var(--goa-color-info-border);
  --goa-badge-info-subtle-color-content: var(--goa-color-info-text-dark);
  --goa-badge-info-subtle-color-bg: var(--goa-color-info-light);
  --goa-badge-info-color-content: var(--goa-color-info-text-inverse);
  --goa-badge-info-color-bg: var(--goa-color-info-default);
  --goa-badge-border-width: var(--goa-border-width-s);
  --goa-badge-border-radius: var(--goa-border-radius-s);
  --goa-badge-icon-size-large: var(--goa-icon-size-m);
  --goa-badge-icon-size: var(--goa-icon-size-s);
  --goa-badge-line-height-large: var(--goa-line-height-2);
  --goa-badge-line-height: var(--goa-line-height-1);
  --goa-badge-font-size-large: var(--goa-font-size-3);
  --goa-badge-font-size: var(--goa-font-size-2);
  --goa-badge-gap: var(--goa-space-2xs);
  --goa-badge-padding-large: 0 var(--goa-space-xs);
  --goa-badge-padding: 0 var(--goa-space-xs);
  --goa-accordion-icon-color-hover: var(--goa-color-greyscale-black);
  --goa-accordion-icon-color: var(--goa-color-greyscale-black);
  --goa-accordion-heading-m: var(--goa-font-weight-medium) var(--goa-font-size-5)/var(--goa-line-height-5) var(--goa-font-family-sans);
  ...
  --goa-accordion-padding-heading-m-icon-right: calc(var(--goa-space-s) - var(--goa-border-width-s)) 0 calc(var(--goa-space-s) - var(--goa-border-width-s)) var(--goa-space-m);
  --goa-accordion-padding-heading-m-icon-left: calc(var(--goa-space-s) - var(--goa-border-width-s)) var(--goa-space-m) calc(var(--goa-space-s) - var(--goa-border-width-s)) 0;
  --goa-accordion-padding-heading-icon-right: calc(var(--goa-space-xs) - var(--goa-border-width-s)) 0 calc(var(--goa-space-xs) - var(--goa-border-width-s)) var(--goa-space-m);
  --goa-accordion-padding-heading-icon-left: calc(var(--goa-space-xs) - var(--goa-border-width-s)) var(--goa-space-m) calc(var(--goa-space-xs) - var(--goa-border-width-s)) 0;
  --goa-accordion-border-radius-focus: var(--goa-border-radius-2xl) var(--goa-border-radius-2xl) var(--goa-border-radius-xs) var(--goa-border-radius-xs);
  --goa-accordion-border-radius: var(--goa-border-radius-2xl);
  ...
  --goa-workspace-layout-mobile-toggle-color: var(--goa-color-text-default);
  ...
  --goa-text-area-typography-compact: var(--goa-typography-body-s);
  --goa-text-area-typography: var(--goa-typography-body-m);
  --goa-text-area-color-text-placeholder: var(--goa-input-color-text-placeholder);
  --goa-text-area-color-text-disabled: var(--goa-input-color-text-disabled);
  --goa-text-area-color-text-counter-error: var(--goa-input-color-border-error);
  --goa-text-area-color-text-counter: var(--goa-input-color-text-secondary);
  --goa-text-area-color-text: var(--goa-input-color-text-secondary);
  --goa-text-area-color-bg-readonly: var(--goa-input-color-background-readonly);
  --goa-text-area-color-bg-disabled: var(--goa-input-color-background-disabled);
  --goa-text-area-color-bg: var(--goa-input-color-background-default);
  --goa-text-area-border-radius: var(--goa-input-border-radius-input);
  --goa-text-area-border-hover: inset 0 0 0 var(--goa-input-border-width-hover) var(--goa-input-color-border-hover);
  --goa-text-area-border-focus: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-focus);
  --goa-text-area-border-error: inset 0 0 0 var(--goa-input-border-width-hover) var(--goa-input-color-border-error);
  --goa-text-area-border-disabled: inset 0 0 0 var(--goa-input-border-width-default) var(--goa-input-color-border-disabled);
  --goa-text-area-border: inset 0 0 0 var(--goa-input-border-width-default) var(--goa-input-color-border-default);
  --goa-temporary-notification-typography: var(--goa-typography-body-m);
  --goa-temporary-notification-color-text: var(--goa-color-text-light);
  --goa-tab-color-text-hover: var(--goa-color-text-default);
  --goa-tab-color-text: var(--goa-color-text-default);
  --goa-table-typography-heading: var(--goa-typography-body-xs);
  --goa-side-menu-group-item-typography: var(--goa-typography-body-xs);
  --goa-side-menu-color-item-current: var(--goa-color-text-default);
  --goa-side-menu-color-item: var(--goa-color-text-default);
  --goa-side-menu-icon-color: var(--goa-color-text-secondary);
  --goa-side-menu-heading-typography: var(--goa-typography-body-xs);
  --goa-radio-inner-color-disabled: var(--goa-color-interactive-disabled);
  ...
  --goa-pagination-text-color: var(--goa-color-text-default);
  --goa-pagination-text-size: var(--goa-typography-body-m);
  --goa-notification-banner-emergency-high-color-text: var(--goa-color-text-light);
  --goa-notification-banner-information-high-color-text: var(--goa-color-text-light);
  ...
  --goa-link-color-light-default: var(--goa-color-text-light);
  ...
  --goa-text-input-lt-content-color-bg-readonly: var(--goa-input-color-background-readonly-content);
  --goa-text-input-color-bg-readonly: var(--goa-input-color-background-readonly);
  --goa-text-input-border-readonly: inset 0 0 0 var(--goa-input-border-width-default) var(--goa-input-color-border-readonly);
  --goa-text-input-typography-compact: var(--goa-typography-body-s);
  --goa-text-input-typography: var(--goa-typography-body-m);
  --goa-text-input-padding: 9px var(--goa-text-input-padding-lr) 11px;
  --goa-text-input-color-text-placeholder: var(--goa-input-color-text-placeholder);
  --goa-text-input-color-text-disabled: var(--goa-input-color-text-disabled);
  --goa-text-input-color-icon-disabled: var(--goa-input-color-text-disabled);
  --goa-text-input-color-bg-disabled: var(--goa-input-color-background-disabled);
  --goa-text-input-color-bg: var(--goa-input-color-background-default);
  --goa-text-input-border-radius: var(--goa-input-border-radius-input);
  --goa-text-input-border-hover: inset 0 0 0 var(--goa-input-border-width-hover) var(--goa-input-color-border-hover);
  --goa-text-input-border-focus: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-focus);
  --goa-text-input-border-error: inset 0 0 0 var(--goa-input-border-width-hover) var(--goa-input-color-border-error);
  --goa-text-input-border-disabled: inset 0 0 0 var(--goa-input-border-width-default) var(--goa-input-color-border-disabled);
  --goa-text-input-border: inset 0 0 0 var(--goa-input-border-width-default) var(--goa-input-color-border-default);
  --goa-icon-button-default-disabled-color: var(--goa-color-interactive-disabled);
  --goa-icon-button-focus-border-color: var(--goa-input-color-border-focus);
  --goa-icon-button-focus-border-width: var(--goa-input-border-width-focus);
  --goa-hero-banner-content: var(--goa-typography-body-l);
  --goa-hero-banner-heading: var(--goa-typography-heading-xl);
  --goa-app-header-color-text-nav-item-in-menu-current-hover: var(--goa-color-text-secondary);
  --goa-app-header-color-text-nav-item-in-menu-current: var(--goa-color-text-secondary);
  ...
  --goa-form-item-help-message-color: var(--goa-input-color-text-helper);
  --goa-form-item-error-message-color: var(--goa-input-color-text-error);
  --goa-footer-color-links-secondary: var(--goa-color-text-secondary);
  --goa-footer-color-text: var(--goa-color-text-default);
  --goa-filter-chip-typography: var(--goa-typography-body-s);
  --goa-filter-chip-secondary-text-color-error: var(--goa-input-color-text-error);
  --goa-filter-chip-icon-color-error: var(--goa-input-color-text-error);
  --goa-filter-chip-border-color-error: var(--goa-input-color-border-error);
  --goa-filter-chip-bg-color-error: var(--goa-input-color-background-error);
  --goa-filter-chip-text-color-error: var(--goa-input-color-border-error);
  --goa-filter-chip-text-color: var(--goa-color-text-default);
  --goa-file-upload-instruction-text: var(--goa-typography-body-m);
  --goa-file-upload-help-text: var(--goa-typography-body-s);
  --goa-dropdown-multiselect-compact-item-typography: var(--goa-typography-body-s);
  --goa-dropdown-multiselect-compact-typography: var(--goa-typography-body-s);
  --goa-dropdown-multiselect-menu-border-radius: var(--goa-input-border-radius-input);
  --goa-dropdown-multiselect-helper-typography: var(--goa-typography-body-xs);
  --goa-dropdown-multiselect-label-typography: var(--goa-typography-body-m);
  --goa-dropdown-multiselect-typography: var(--goa-typography-body-m);
  --goa-dropdown-multiselect-item-color-text-selected-hover: var(--goa-color-text-light);
  --goa-dropdown-multiselect-item-color-text-hover: var(--goa-color-text-default);
  --goa-dropdown-multiselect-item-color-text-disabled: var(--goa-color-text-disabled);
  --goa-dropdown-multiselect-item-color-text: var(--goa-color-text-secondary);
  ...
  --goa-dropdown-multiselect-border-radius: var(--goa-input-border-radius-input);
  --goa-dropdown-multiselect-border-error-hover: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-error-hover);
  --goa-dropdown-multiselect-border-hover: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-hover);
  --goa-dropdown-multiselect-border-focus: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-focus);
  --goa-dropdown-multiselect-border-error: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-error);
  --goa-dropdown-multiselect-border-disabled: inset 0 0 0 var(--goa-input-border-width-default) var(--goa-input-color-border-disabled);
  --goa-dropdown-multiselect-border: inset 0 0 0 var(--goa-input-border-width-default) var(--goa-input-color-border-default);
  --goa-dropdown-compact-item-typography: var(--goa-typography-body-s);
  --goa-dropdown-compact-typography: var(--goa-typography-body-s);
  --goa-dropdown-menu-border-radius: var(--goa-input-border-radius-input);
  --goa-dropdown-helper-typography: var(--goa-typography-body-xs);
  --goa-dropdown-label-typography: var(--goa-typography-body-m);
  ...
  --goa-dropdown-color-bg: var(--goa-input-color-background-default);
  --goa-dropdown-border-radius: var(--goa-input-border-radius-input);
  --goa-dropdown-border-error-hover: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-error-hover);
  --goa-dropdown-border-hover: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-hover);
  --goa-dropdown-border-focus: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-focus);
  --goa-dropdown-border-error: inset 0 0 0 var(--goa-input-border-width-focus) var(--goa-input-color-border-error);
  --goa-dropdown-border-disabled: inset 0 0 0 var(--goa-input-border-width-default) var(--goa-input-color-border-disabled);
  --goa-dropdown-border: inset 0 0 0 var(--goa-input-border-width-default) var(--goa-input-color-border-default);
  --goa-drawer-heading-typography: var(--goa-typography-heading-s);
  --goa-details-icon-color: var(--goa-color-text-default);
  --goa-details-content-typography: var(--goa-typography-body-m);
  --goa-details-color-text: var(--goa-color-text-default);
  --goa-date-input-day-color-text-disabled: var(--goa-input-color-text-disabled);
  --goa-date-input-day-color-text-other-month: var(--goa-input-color-text-disabled);
  ...
  --goa-date-input-day-font-today: var(--goa-typography-heading-2xs);
  --goa-date-input-day-font: var(--goa-typography-body-s);
  --goa-date-input-day-of-week-font: var(--goa-typography-heading-2xs);
  --goa-date-input-calendar-border-radius: var(--goa-input-border-radius-input);
  --goa-date-input-calendar-border: var(--goa-input-border-width-default) solid var(--goa-input-color-border-default);
  ...
  --goa-container-heading: var(--goa-typography-heading-xs);
  --goa-checkbox-label-font-size-compact: var(--goa-typography-body-s);
  --goa-checkbox-label-font-size: var(--goa-typography-body-m);
  --goa-checkbox-description-font-size: var(--goa-typography-body-xs);
  --goa-checkbox-color-label-disabled: var(--goa-input-color-text-disabled);
  --goa-checkbox-color-label: var(--goa-input-color-text-secondary);
  --goa-checkbox-color-bg: var(--goa-input-color-background-default);
  --goa-checkbox-border-radius: var(--goa-input-border-radius-checkbox);
  --goa-checkbox-border-disabled: var(--goa-input-border-width-default) solid var(--goa-input-color-border-default);
  --goa-checkbox-border: var(--goa-input-border-width-default) solid var(--goa-input-color-border-default);
  --goa-callout-h-emergency-heading-color: var(--goa-color-text-light);
  --goa-callout-h-success-heading-color: var(--goa-color-text-light);
  --goa-callout-h-important-heading-color: var(--goa-color-text-default);
  --goa-callout-h-info-heading-color: var(--goa-color-text-light);
  ...
  --goa-button-tertiary-focus-color-text: var(--goa-color-text-default);
  --goa-button-tertiary-hover-color-text: var(--goa-color-text-default);
  --goa-button-tertiary-color-text: var(--goa-color-text-default);
  --goa-button-primary-inverse-hover-color-text: var(--goa-color-text-light);
  --goa-button-primary-inverse-color-text: var(--goa-color-text-light);
  --goa-button-primary-disabled-color-text: var(--goa-color-text-light);
  --goa-button-primary-disabled-color-bg: var(--goa-color-interactive-disabled);
  ...
  --goa-badge-archived-subtle-color-content: var(--goa-color-text-default);
  --goa-badge-default-subtle-color-content: var(--goa-color-text-default);
  --goa-badge-default-color-content: var(--goa-color-text-light);
  --goa-accordion-heading-secondary-text-color: var(--goa-color-text-default);
  --goa-accordion-heading-m-secondary-text: var(--goa-typography-body-s);
  --goa-accordion-heading-secondary-text: var(--goa-typography-body-xs);
