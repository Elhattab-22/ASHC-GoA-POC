...
$goa-accordion-border-radius: 1rem;
$goa-accordion-border-radius-focus: 1rem 1rem 0.25rem 0.25rem;
$goa-accordion-padding-heading-icon-left: calc(0.5rem - 1px) 1rem calc(0.5rem - 1px) 0;
$goa-accordion-padding-heading-icon-right: calc(0.5rem - 1px) 0 calc(0.5rem - 1px) 1rem;
$goa-accordion-padding-heading-m-icon-left: calc(0.75rem - 1px) 1rem calc(0.75rem - 1px) 0;
$goa-accordion-padding-heading-m-icon-right: calc(0.75rem - 1px) 0 calc(0.75rem - 1px) 1rem;
...
$goa-container-interactive-bg-color: #ffffff;
...
$goa-dropdown-multiselect-border: inset 0 0 0 1px #808080;
$goa-dropdown-multiselect-border-disabled: inset 0 0 0 1px #b1b1b1;
$goa-dropdown-multiselect-border-error: inset 0 0 0 2px #ec040b;
$goa-dropdown-multiselect-border-focus: inset 0 0 0 2px #006dcc;
$goa-dropdown-multiselect-border-hover: inset 0 0 0 2px #000000;
$goa-dropdown-multiselect-border-error-hover: inset 0 0 0 2px #ba0000;
$goa-dropdown-multiselect-border-radius: 0.5rem;
$goa-dropdown-multiselect-color-bg: #ffffff;
...
$goa-dropdown-multiselect-item-color-bg-hover: #f2f0f0;
$goa-dropdown-multiselect-item-color-bg-selected: #006dcc;
$goa-dropdown-multiselect-item-color-bg-selected-hover: #045092;
$goa-dropdown-multiselect-item-color-text: #6f6f6f;
$goa-dropdown-multiselect-item-color-text-disabled: #4d4d4d;
$goa-dropdown-multiselect-item-color-text-hover: #000000;
$goa-dropdown-multiselect-item-color-text-selected: #ffffff;
$goa-dropdown-multiselect-item-color-text-selected-hover: #ffffff;
$goa-dropdown-multiselect-item-padding: 0.75rem 0.5rem;
$goa-dropdown-multiselect-item-border-radius: 0.375rem;
$goa-dropdown-multiselect-height: 56px;
$goa-dropdown-multiselect-padding: 1rem 0.75rem;
$goa-dropdown-multiselect-padding-vertical: 1rem;
$goa-dropdown-multiselect-padding-lr: 0.75rem;
$goa-dropdown-multiselect-space-icon-text: 0.75rem;
$goa-dropdown-multiselect-transition: box-shadow 0.05s ease-in;
$goa-dropdown-multiselect-typography: 400 1.125rem/1.5rem acumin-variable, helvetica-neue, arial, sans-serif;
$goa-dropdown-multiselect-label-typography: 400 1.125rem/1.5rem acumin-variable, helvetica-neue, arial, sans-serif;
$goa-dropdown-multiselect-helper-typography: 400 0.875rem/1.25rem acumin-variable, helvetica-neue, arial, sans-serif;
$goa-dropdown-multiselect-menu-border-radius: 0.5rem;
$goa-dropdown-multiselect-menu-margin: 0.5rem;
$goa-dropdown-multiselect-compact-height: 40px;
$goa-dropdown-multiselect-compact-typography: 400 1rem/1.375rem acumin-variable, helvetica-neue, arial, sans-serif;
$goa-dropdown-multiselect-compact-padding: 0 0.75rem;
$goa-dropdown-multiselect-compact-item-padding: 0 0.5rem;
$goa-dropdown-multiselect-compact-item-typography: 400 1rem/1.375rem acumin-variable, helvetica-neue, arial, sans-serif;
$goa-dropdown-multiselect-divider: 1px solid #cdcdcd;
...
$goa-footer-color-text: #000000;
$goa-footer-color-links: #000000;
$goa-footer-color-links-hover: #4d4d4d;
$goa-footer-color-links-secondary: #6f6f6f;
...
$goa-step-color-step-number: #6f6f6f;
$goa-step-color-sublabel: #6f6f6f;
...
$goa-app-header-secondary-text-color: #6f6f6f;
...
$goa-app-header-color-text-nav-item: #6f6f6f;
$goa-app-header-color-text-nav-item-current: #6f6f6f;
$goa-app-header-nav-text-color: #6f6f6f;
...
$goa-app-header-color-text-nav-item-in-menu-current: #6f6f6f;
$goa-app-header-color-text-nav-item-in-menu-current-hover: #6f6f6f;
...
$goa-linear-progress-percentage-color: #6f6f6f;
...
$goa-microsite-header-color-version-number: #6f6f6f;
...
$goa-notification-banner-padding-lr-medium-screen: 1.5rem;
...
$goa-notification-banner-important-low-close-bg-hover: #fde3a1;
...
$goa-scroll-panel-color-bg: #ffffff;
$goa-scroll-panel-header-color-bg: #ffffff;
$goa-scroll-panel-footer-color-bg: #ffffff;
...
$goa-scroll-panel-header-scroll-border: #e9e9e9;
$goa-scroll-panel-header-scroll-shadow: 0px 1px 8px 0px rgba(0,0,0,0.07);
$goa-scroll-panel-footer-scroll-border: #e9e9e9;
$goa-scroll-panel-footer-scroll-shadow: 0px -2px 16px 0px rgba(0,0,0,0.1);
...
$goa-side-menu-icon-color: #6f6f6f;
...
$goa-work-side-menu-popover-shadow: 0px 12px 16px -4px rgba(16,29,40,0.08), 0px 4px 6px -2px rgba(16,29,40,0.03);
...
$goa-workspace-layout-bg-color: #f8f8f8;
$goa-workspace-layout-card-bg-color: #ffffff;
$goa-workspace-layout-header-bg-color: #ffffff;
$goa-workspace-layout-header-border-bottom: 1px solid #cdcdcd;
$goa-workspace-layout-header-scroll-border-color: #cdcdcd;
$goa-workspace-layout-header-scroll-shadow: 0px 1px 8px 0px rgba(0,0,0,0.07);
$goa-workspace-layout-footer-bg-color: #ffffff;
$goa-workspace-layout-footer-border-top: 1px solid #cdcdcd;
$goa-workspace-layout-footer-scroll-border-color: #cdcdcd;
$goa-workspace-layout-footer-scroll-shadow: 0px -2px 16px 0px rgba(0,0,0,0.1);
$goa-workspace-layout-mobile-toggle-top: 1.5rem;
$goa-workspace-layout-mobile-toggle-left: 0.75rem;
$goa-workspace-layout-mobile-toggle-size: 2rem;
$goa-workspace-layout-mobile-toggle-color: #000000;
$goa-workspace-layout-mobile-header-padding-left: 3rem;
...
$goa-color-text-secondary: #6f6f6f;
...
$goa-color-surface-page: #f8f8f8;
$goa-color-surface-default: #ffffff;
$goa-color-surface-card: #ffffff;
$goa-color-surface-section: #f8f8f8;
$goa-color-surface-input: #f8f8f8;
$goa-color-surface-content-body: #f2f0f0;
$goa-color-surface-widget: #ffffff;
$goa-color-surface-heading: #f2f0f0;
$goa-color-surface-item: #f8f8f8;
